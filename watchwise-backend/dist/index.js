...
const routes_4 = require("./data/preferences/routes");
const routes_5 = require("./data/watch-history/routes");
const routes_6 = require("./data/movies/routes");
const routes_7 = require("./data/lists/routes");
const routes_8 = require("./data/groups/routes");
const routes_9 = require("./data/group-sessions/routes");
...
const start = async () => {
    try {
        ...
        await (0, routes_4.preferenceRoutes)(app);
        await (0, routes_5.watchHistoryRoutes)(app);
        await (0, routes_6.movieRoutes)(app);
